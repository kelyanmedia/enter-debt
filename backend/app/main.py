...
def _migrate():
    ...
    migrations = [
        ...
        "ALTER TABLE employee_tasks ADD COLUMN IF NOT EXISTS pl_salary_uzs_locked NUMERIC(15, 2)",
        "ALTER TABLE employee_tasks ADD COLUMN IF NOT EXISTS pl_usd_to_uzs_rate_applied NUMERIC(15, 4)",
        "ALTER TABLE employee_payment_records ADD COLUMN IF NOT EXISTS budget_amount NUMERIC(15, 2) NOT NULL DEFAULT 0",
        "ALTER TABLE employee_payment_records ADD COLUMN IF NOT EXISTS pl_salary_uzs_locked NUMERIC(15, 2)",
        "ALTER TABLE employee_payment_records ADD COLUMN IF NOT EXISTS pl_usd_to_uzs_rate_applied NUMERIC(15, 4)",
