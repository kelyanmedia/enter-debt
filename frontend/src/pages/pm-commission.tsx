...
import { PageHeader, Card, Empty, formatMoneyNumber } from '@/components/ui'
...
export default function PmCommissionPage() {
  ...
  return (
    <Layout>
      <PageHeader
        title="Моя комиссия"
        subtitle="Только ваши проекты и сумма к выплате. Прибыль и чужие комиссии здесь не показываются."
      />

      {loading && (
        <p style={{ color: '#94a3b8', padding: 24 }}>Загрузка…</p>
      )}
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', gap: 16, flexWrap: 'wrap' }}>
                <div style={{ flex: 1, minWidth: 200 }}>
                  ...
                  <div style={{ fontSize: 12, color: '#94a3b8' }}>
                    ...
                    {r.actual_close_date && (
                      <> · Закрыт: {fmtDate(r.actual_close_date)}</>
                    )}
                  </div>
        ...
        {manualOpen && (
          <Card style={{ marginTop: 8, lineHeight: 1.65, color: '#475569', fontSize: 14 }}>
            ...
            <ul style={{ paddingLeft: 20 }}>
              <li><strong>5%</strong> — если сдал проект <strong>в срок</strong>.</li>
              <li>
                <strong>6%</strong> — если сдал <strong>в срок</strong>, клиент поставил оценку <strong>9 или 10</strong>,
                и проект взяли в портфолио как показательный кейс. Это максимум.
              </li>
              <li>
                <strong>4%</strong> — если опоздал <strong>не больше чем на месяц</strong>, но качество в порядке
                и клиент доволен (оценка от <strong>6</strong>).
              </li>
              <li>
            ...
            <ul style={{ paddingLeft: 20 }}>
              <li>
                Комиссия начисляется только когда проект полностью закрыт: клиент оплатил финал и оставил оценку (NPS).
                Нет оплаты или оценки — проект не закрыт, комиссия в режиме «прогноз».
              </li>
              <li>
              ...
              <li>
                Если сроки сдвинулись <strong>по вине клиента</strong> (не дал вовремя контент, не согласовал) —
                это фиксируется отдельно и <strong>против тебя не считается</strong>. Скажи руководителю, чтобы оформил перенос.
              </li>
            </ul>
