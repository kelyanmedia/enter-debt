...
export default function FinancePlPage() {
  ...
  return (
    <Layout>
      <PageHeader
        title="P&L"
        subtitle="Выручка по категориям проектов (факт оплат по графику). Расходы ДДС — по категориям, в т.ч. «Агаси Д (дивиденды)» для личного вывода. Суммы в USD в ДДС и выплатах команде за месяц переводятся в сумы по курсу из блока «Курс для P&L» на странице ДДС (при ненулевом курсе за этот месяц). В итоге: операционный результат без Агаси Д; «Чистая прибыль» — только суммы Агаси Д из ДДС."
      />
      <div
        style={{
          flex: 1,
