...
export default function FinancePlPage() {
  ...
  return (
    <Layout>
      <PageHeader
        title="P&L"
        subtitle="Выручка по категориям проектов (факт оплат по графику). Постоянные расходы: команда + ДДС (офис, бухгалтерия, паблики, налоги, личный бренд, маркетинг и прочее по категориям строк ДДС)."
      />
      <div
        style={{
          flex: 1,
      ...
      >
        ...
        <p style={{ fontSize: 12, color: '#64748b', lineHeight: 1.55, margin: 0, maxWidth: '100%' }}>
          ...
          и расходы по статьям — из раздела «ДДС». Зарплатный фонд объединяет выплаты в «Команда» и расходы ДДС с
          категорией «Зарплата» (в т.ч. шаблон Влад, Обиджон, Суннат, Рустам). Не дублируйте в ДДС приход то, что уже
          отражено оплатами по проектам, если не нужен отдельный кассовый учёт.
        </p>
      </div>
    </Layout>
  )
